...
#Create a pod with no specific policy...we can see the scheduling, container pulling and container starting.
...
# Now try deleting the process couple of times and see BackOff kicking off
